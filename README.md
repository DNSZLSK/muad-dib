...
### <!--stat:rulesTotal-->279<!--/stat:rulesTotal--> detection rules

All rules (<!--stat:rulesCore-->274<!--/stat:rulesCore--> RULES + <!--stat:rulesParanoid-->5<!--/stat:rulesParanoid--> PARANOID) are mapped to MITRE ATT&CK techniques. See [SECURITY.md](SECURITY.md#detection-rules-v211139) for the complete rules reference.
...
- [Security Policy](SECURITY.md) - Detection rules reference (<!--stat:rulesTotal-->279<!--/stat:rulesTotal--> rules)
