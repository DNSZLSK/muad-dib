...
async function runMaintainerChangeTests() {
  ...
  // NOTE (audit 2026-07): the former « mock — » tests that re-implemented the
  // set-diff/decision loops inline were removed. Every scenario they covered
  // (sole-maintainer change, new maintainer, no change, publisher change) is
  // exercised against the REAL detectMaintainerChange below via withMockedFetchMaint.
