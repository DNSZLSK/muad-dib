...
`;
  ...
  // Drift gate derived from stats.json (single source of truth, regenerated by
  // `npm run docs:stats`) rather than a hand-maintained literal duplicated here
  // and in v266-fixes.test.js. Still fails on real code↔stats drift.
  test('v8b: RULES / PARANOID_RULES counts match stats.json (drift gate)', () => {
