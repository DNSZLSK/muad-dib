...
`;
  ...
  test('v8b: rule count is 272 RULES + 5 PARANOID (Track D +3, gyp_command_exec +1, gyp_phantom_exec +1, GHA-005/006 +2, lifecycle_version99 COMPOUND-018 +1, anti_analysis_evasion + analyzer_honeytoken_reference AST-095/096 +2, electron_app_injection AST-097 +1, install_native_drop_exec COMPOUND-020 +1, binary_masquerading_as_source BINSRC-001 +1)', () => {
