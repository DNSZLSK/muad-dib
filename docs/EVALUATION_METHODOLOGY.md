...
|--------|--------|-------------|
| **Wild TPR** (Datadog 17K) | **92.8%** (13,538/14,587 in-scope) | 17,922 packages. 3,335 skipped (no JS). compromised_lib 97.8%, malicious_intent 92.1% (see section 15) |
| **TPR@3** (Ground Truth, v2.10.95 metrics) | **93.85%** (61/65 active) | 67 real-world attacks (65 active, 2 out-of-scope: GT-005 colors, GT-009 faker — protestware with min_threats=0). 4 misses include 3 browser-only (lottie-player, polyfill-io, trojanized-jquery) plus 1 other |
| **TPR@20** (Ground Truth, v2.10.95 metrics) | **86.2%** (56/65 active) | Operational alert threshold = 20 |
| **FPR** (Benign curated, v2.10.95 measure) | **15.6%** (85/545 scanned of 548) | npm packages, real source code, threshold > 20. The v2.10.74 estimated 6-9% reduction did NOT materialize on the rebuilt corpus |
