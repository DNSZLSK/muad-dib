...
Datasets : 14 587 samples Datadog in-scope, 548 npm curated + 200 npm random + 132 PyPI packages benins, 107 samples adversariaux/holdout, **96 attaques ground-truth** (94 in-scope + 2 hors-scope : GT-005 colors, GT-009 faker, protestware min_threats=0; 13 samples PyPI added 2026-05-25). **<!--stat:tests-->4534<!--/stat:tests--> tests**, <!--stat:testFiles-->152<!--/stat:testFiles--> fichiers.
...
- **<!--stat:tests-->4534<!--/stat:tests--> tests unitaires/integration** sur <!--stat:testFiles-->152<!--/stat:testFiles--> fichiers modulaires via [Codecov](https://codecov.io/gh/DNSZLSK/muad-dib)
