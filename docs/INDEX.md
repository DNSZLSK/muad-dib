...
| [SECURITY.md](../SECURITY.md) | Security policy, <!--stat:rulesTotal-->277<!--/stat:rulesTotal--> detection rules reference (canonical source) |
...
## Current Metrics (v<!--stat:version-->2.11.178<!--/stat:version-->; detection metrics last measured v2.11.48)

| Metric | Value |
|--------|-------|
| Tests | **<!--stat:tests-->4543<!--/stat:tests-->** across <!--stat:testFiles-->152<!--/stat:testFiles--> files |
...
├── rules/index.js         # 277 threat rules (272 RULES + 5 PARANOID, MITRE mapped)
