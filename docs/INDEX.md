...
| [SECURITY.md](../SECURITY.md) | Security policy, <!--stat:rulesTotal-->278<!--/stat:rulesTotal--> detection rules reference (canonical source) |
...
## Current Metrics (v<!--stat:version-->2.12.0<!--/stat:version-->; detection metrics last measured v2.11.48)

| Metric | Value |
|--------|-------|
| Tests | **<!--stat:tests-->4545<!--/stat:tests-->** across <!--stat:testFiles-->155<!--/stat:testFiles--> files |
| Rules | **<!--stat:rulesTotal-->278<!--/stat:rulesTotal-->** (<!--stat:rulesCore-->273<!--/stat:rulesCore--> RULES + <!--stat:rulesParanoid-->5<!--/stat:rulesParanoid--> PARANOID - v2.11.67/70 Phantom Gyp added PKG-023 + COMPOUND-017) |
...
├── pipeline/              # Pipeline stages: initializer, executor (22 scanners), processor, outputter
...
├── scanner/               # 22 parallel scanners + 2 pre-analysis modules + python-ast bootstrap
...
├── rules/index.js         # 278 threat rules (273 RULES + 5 PARANOID, MITRE mapped)
