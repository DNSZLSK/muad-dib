...
```bash
npm test          # Run all tests (custom framework, 4545 tests across 155 files)
...
## Current Metrics (v<!--stat:version-->2.12.0<!--/stat:version-->; detection metrics last fully measured v2.11.48)

| Metric | Value |
|--------|-------|
| Version | **<!--stat:version-->2.12.0<!--/stat:version-->** |
| Tests | **4535** passed, **5 failed** locally (Windows-only env flakes — `tar --force-local` ×3 EXTRACT-POOL, temp-file `UNKNOWN` ×2 PACKAGE; **0 failed on Linux/CI**), across **<!--stat:testFiles-->155<!--/stat:testFiles-->** files (14511 skipped when Docker absent). Total non-skipped: <!--stat:tests-->4545<!--/stat:tests-->. |
